...
> - A variety of different sensor readings such as NO, NO_2_, Temperature and Humidity 
...
## Statistical Methodology for Time Series Data

> - Bayesian modelling for interpretable results and accurate uncertainty
> - Dynamic Linear Models using the Kalman Filter
> - Particle Filtering for flexibly fitting continuous time non-Gaussian Models
> - MCMC and pMCMC to determine static parameters
...
> - Select humidity and temperature data
...
## Determine the static parameters
